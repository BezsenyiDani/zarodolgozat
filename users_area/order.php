...
while($row_price=mysqli_fetch_array($result_cart_price)){
    $product_id=$row_price['termek_id'];
    $select_product="Select * from `termekek` where termek_id=$product_id";
...
if($result_query){
    //echo "<script>alert('A rendelés jóvá lett hagyva.')</script>";
...
$empty_cart="Delete from `cart_details` where ip_adress='$get_ip_address'";
